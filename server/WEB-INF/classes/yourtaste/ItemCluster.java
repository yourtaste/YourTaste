...
public class ItemCluster {
        ...
        try {
          ...
          //  System.out.println(ColCount);
            ...
            while (rs.next()) {    
                ...
                array[a][6] = rs.getString("foodid6");
                array[a][7] = rs.getString("foodid7");
                array[a][8] = rs.getString("foodid8");
                array[a][9] = rs.getString("foodid9");
                array[a][10] = rs.getString("foodid10");
                array[a][11] = rs.getString("foodid11");
                array[a][12] = rs.getString("foodid12");
                array[a][13] = rs.getString("foodid13");
                array[a][14] = rs.getString("foodid14");
                array[a][15] = rs.getString("foodid15");
                array[a][16] = rs.getString("foodid16");
                array[a][17] = rs.getString("foodid17");
                array[a][18] = rs.getString("foodid18");
                array[a][19] = rs.getString("foodid19");
                array[a][20] = rs.getString("foodid20");
          ...
          /*  for (int i = 0; i < array.length; i++) {
            ...
            String createfile = "/var/lib/tomcat8/webapps/ROOT/WEB-INF/classes/yourtaste/TasteData1.csv";
            String createfile2 = "/var/lib/tomcat8/webapps/ROOT/WEB-INF/classes/yourtaste/TasteData2.csv";
            ...
            for(int i = 0; i<rowCount; i++) {
            	...
            	fw.append(array[i][9]);
            	fw.append(',');
            	fw.append(array[i][10]);
            	fw.append(',');
            	fw.append(array[i][11]);
            	fw.append(',');
            	fw.append(array[i][12]);
            	fw.append(',');
            	fw.append(array[i][13]);
            	fw.append(',');
            	fw.append(array[i][14]);
            	fw.append(',');
            	fw.append(array[i][15]);
            	fw.append(',');
            	fw.append(array[i][16]);
            	fw.append(',');
            	fw.append(array[i][17]);
            	fw.append(',');
            	fw.append(array[i][18]);
            	fw.append(',');
            	fw.append(array[i][19]);
            	fw.append(',');
            	fw.append(array[i][20]);
            	fw.append('\n');
            }
	...
	public static String[][] Usersim(int DBUserId) throws IOException {
		...
		String array[][] = null;
		int rowcount = countLines("/var/lib/tomcat8/webapps/ROOT/WEB-INF/classes/yourtaste/TasteData1.csv");
		
		array = new String[rowcount][20];
				
		try {
			File csv = new File("/var/lib/tomcat8/webapps/ROOT/WEB-INF/classes/yourtaste/TasteData1.csv");
	...
	public static String[][] Itemreco(int UserNum) throws IOException{
		...
		Float array[][] = null;
		int rowcount = countLines("/var/lib/tomcat8/webapps/ROOT/WEB-INF/classes/yourtaste/TasteData2.csv");
		
		array = new Float[rowcount][3];
				
		try {
			File csv = new File("/var/lib/tomcat8/webapps/ROOT/WEB-INF/classes/yourtaste/TasteData2.csv");
            BufferedReader br = new BufferedReader(new FileReader(csv));
            String line = "";
            int row =0 ,i;
    		...
    		for(int h = 1; h<Usersimilar[1].length; h++) {
    			for(int o = 0; o<rowcount; o++) {
    				if(array[o][0] == Usersimilar[1][h] && Usersimilar[0][h] > 0.0) {
    						...
    						Itemrecom[1][index] = 3*(array[o][2]) + Itemrecom[1][index];
    						index++;
    				}
    			}
    			index = 0;
